<template>
<Img :height="$vuetify.breakpoint.mdAndUp ? 1150 : 850" src="https://cdn.vuetifyjs.com/images/parallax/material2.jpg" flat max-width="100%" tile>
<v-container>
...
export default {
  ...
  data: () => ({
    ...
    slides: [{
        color: '#1A2238',
        title: 'Basic intention',
        text: 'Distribute relief supplies better.',
      },
      {
        color: '#61082B',
        title: 'Make your donation count',
        text: 'We want donations to get to where they are needed.',
      },
      {
        color: '#1B5E20',
        title: 'How can you help?',
        text: 'Sign up now and donate the things you no longer need.',
      },
    ]
  }),
